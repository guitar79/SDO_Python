...
targets = ['2048_HMII.jpg','1024_HMII.jpg', 
           '1024_0304.jpg', '1024_4500.jpg', 
           '1024_HMIIB.jpg', '1024_HMIIC.jpg', 
           '1024_0171.jpg', '1024_0131.jpg'] #this tpye of image will be downloading
targets = ['2048_HMII.jpg','1024_HMII.jpg'] #this tpye of image will be downloading
time_gap = 1 #time gap
...
for SDO_filelist in SDO_filelists:
    ...
    for batch in range(num_batches):
        ...
        for SDO_filelist in SDO_filelists[batch*num_cpu:(batch+1)*num_cpu] :
            ...
            #myMP.run(f, fullname)
            myMP.run(_SDO_utilities.SDO_image_downloader_from_filelist, SDO_filelist, targets, request_hour)
